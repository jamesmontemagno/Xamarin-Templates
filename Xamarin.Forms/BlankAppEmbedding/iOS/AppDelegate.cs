...
using BlankAppEmbedded2.iOS.Helpers;
using Foundation;
using UIKit;
using Xamarin.Forms;

namespace BlankAppEmbedded.iOS
{
    ...
    public class AppDelegate : UIApplicationDelegate
    {
        ...
        public override bool FinishedLaunching(UIApplication application, NSDictionary launchOptions)
        {
            ...
            //Initialize Xamarin.Forms & navigation
            Forms.Init();
            ...
            // Grab our start page and set it as the root of the Navigation Controller
